...
export const FETCH_INIT = 'FETCH_INIT_UNITS';
export const FETCHED = 'FETCHED_UNITS';
export const FETCHED_FAIL = 'FETCHED_FAIL_UNITS';
export const FETCHED_FILTER = 'FETCHED_FILTER_UNITS';
// export const NEXT_PREQUESTS = 'NEXT_PREQUESTS';
// export const PREV_PREQUESTS = 'PREV_PREQUESTS';
export const FETCH_NEXT = 'FETCH_NEXT_UNITS';
export const FILTER = 'FILTER_UNITS';
export const RESET_FILTER = 'RESET_FILTER_UNITS';
export const SET_SORTING = 'SET_SORTING_UNITS';
export const SET_FILTER = 'SET_FILTER_UNITS';
export const SET_PAGE = 'SET_PAGE_UNITS';
export const CHANGE_PAGE = 'CHANGE_PAGE_UNITS';
export const CHANGE_STATUS= 'CHANGE_STATE_UNITS';
export const SET_SERVER_PAGE = 'SET_SERVER_PAGE_UNITS';
export const CREATE_DATA = 'CREATE_UNITS';
export const UPDATE_DATA = 'UPDATE_UNITS';
export const DELETE_ITEM = 'DELETE_UNITS';

export function actionFetchUnit(index = 1, sorting = {}, filter = {}) {
...
export function actionFilterUnitRequests(value) {
...
export function actionChangeStatusUnitRequests(id, status) {
...
export function actionResetFilterUnitRequests() {
    return {
        type: RESET_FILTER,
        payload: null,
    };
...
export function actionSetPageUnitRequests(page) {
