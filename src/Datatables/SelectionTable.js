...
class SelectionTable extends React.Component {
    ...
    _renderTableCells(row) {
        ...
        return columns.map((val, index) => {
            return (
                <TableCell className={classes.tableCell} style={('style' in val) ? val.style : {} }>
        ...
        return (
            <div className={classes.root}>
                <div className={classes.paper}>
                    {/*<SelectionTableToolbar numSelected={selected.length}/>*/}
...
export default  withStyles(useStyles)(SelectionTable)
