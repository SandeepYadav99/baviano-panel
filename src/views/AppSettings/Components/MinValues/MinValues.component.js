...
class MinValue extends Component {
    ...
    componentDidMount() {
        ...
        if (data) {
            requiredFields = ['min_value', 'min_percentage'];
                ...
                <form onSubmit={handleSubmit(this._handleSubmit)}>
                    <div className={'formFlex'}>
                        <div className={'formGroup'}>
                            <Field fullWidth={true} name="min_value" component={renderOutlinedTextField}
                                   margin={'dense'}
                                   type={'number'}
                                   label="Min value"/>
                        </div>
                        <div className={'formGroup'}>
                            <Field fullWidth={true} name="min_percentage" component={renderOutlinedTextField}
                                   margin={'dense'}
                                   type={'number'}
