...
import {serviceGetNewCustomers, serviceGetRechargeTransaction} from "../../services/Analytics.service";
...
class RechargeList extends Component {
    ...
    _initializeData() {
        ...
        const req = serviceGetRechargeTransaction(start_date, end_date);
        req.then((res) => {
            if (!res.error) {
