...
import {
    actionFetchUnit,
    actionChangePageUnitRequests,
    actionChangeStatusUnitRequests,
    actionFilterUnitRequests,
    actionResetFilterUnitRequests,
    actionSetPageUnitRequests,
    actionCreateUnit,
    actionUpdateUnit,
    actionDeleteUnit
...
class UnitList extends Component {
    ...
    _handleDelete(id) {
        this.props.actionDeleteUnit(id);
        this.setState({
            side_panel: !this.state.side_panel,
            edit_data: null,
        });
...
function mapDispatchToProps(dispatch) {
    return bindActionCreators({
        ...
        actionSetPage: actionSetPageUnitRequests,
        actionResetFilter: actionResetFilterUnitRequests,
        actionSetFilter: actionFilterUnitRequests,
        actionChangeStatus: actionChangeStatusUnitRequests,
        actionCreateUnit: actionCreateUnit,
        actionUpdateUnit: actionUpdateUnit,
        actionDeleteUnit : actionDeleteUnit
    }, dispatch);
}
